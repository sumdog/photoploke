package util;
//Taken From http://marc.info/?l=batik-users&m=100894596006232&w=2
/*****************************************************************************
...
public class SVGRasterizer {
    ...
    /*public static void main(String [] args) throws Exception {
        ...
        f.getContentPane().add(new javax.swing.JLabel(new
                javax.swing.ImageIcon(img)), java.awt.BorderLayout.CENTER);  f.pack();
        f.show();
    } */
}
